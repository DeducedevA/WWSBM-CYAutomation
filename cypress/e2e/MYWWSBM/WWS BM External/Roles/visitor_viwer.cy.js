...
describe('MYWWSBM External Client dministrator', function () {
    ...
    it('Home', function () {
        ...
        // Login details
        loginPage.login(this.mywwsbm_data.VV_username, this.mywwsbm_data.VV_password);
    ...
    it('Settings (Notifications)', function () {
        ...
        loginPage.login(this.mywwsbm_data.VV_username, this.mywwsbm_data.VV_password);  // Login Details
