...
describe('MYWWSBM External Client dministrator', function () {
    ...
    it('Home', function () {
        ...
        // Login details
        loginPage.login(this.mywwsbm_external.RM_username, this.mywwsbm_external.RM_password);
    ...
    it('Settings (Notifications)', function () {
        ...
        loginPage.login(this.mywwsbm_external.RM_username, this.mywwsbm_external.RM_password);  // Login Details
